...
def _system_prompt(language: str) -> str:
    return (
        ...
        "expert verification.\n"
        "2. Do NOT translate or alter: gene symbols (e.g. GNAS, FBN1), OMIM / ORPHA / "
        "PMID / NCT codes, other identifiers, numbers, dates, or URLs. Copy them "
        "exactly as they appear.\n"
        "3. Translate faithfully and completely — do not summarise, add, or omit.\n\n"
