    ...
    <div className="page page--about">
      ...
      <article className="about__article">
        <section className="about__sec">
          ...
          <p>
            A rapidly growing bone lesion in a child&apos;s craniofacial skeleton was biopsied and read as juvenile
            trabecular ossifying fibroma — a diagnosis whose standard of care is extensive surgery. The
            histopathologist worked carefully and ordered additional verifications; no genetic test was suggested,
            although the current literature on the actual disease — fibrous dysplasia — holds that GNAS sequencing
            is essential to differentiate the two. The family ordered the test privately. The diagnosis changed.
          </p>
          <p>
          ...
          <div className="about__stats">
            <div className="about__stat">
              ...
              <div className="about__stat-label">
                New publications indexed by PubMed. Roughly 30 per day in rare diseases alone.
              </div>
            </div>
            <div className="about__stat">
        ...
        <section className="about__sec">
          ...
          <h3 className="about__h3">For families</h3>
          <p>
          ...
          <h3 className="about__h3">For clinicians</h3>
          <p>
