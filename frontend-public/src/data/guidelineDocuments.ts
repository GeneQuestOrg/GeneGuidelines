...
export const GUIDELINE_DOCUMENTS: Readonly<Record<string, GuidelineDocument>> = {
  fd: {
    ...
    basedOn:
      "Boyce et al. 2019 (PMID 31337488) plus 23 approved update PRs through April 2026",
    status: "consensus",
        ...
        paragraphs: [
          {
            ...
            citations: ["31337488", "36119872", "37234561"],
          ...
          },
          {
            ...
            citations: ["37889911", "38112233", "38334455"],
      ...
      },
      {
        ...
        paragraphs: [
          ...
          },
          {
            ...
            citations: ["38445566", "38556677", "35112233"],
